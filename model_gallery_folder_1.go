...
type _GalleryFolder1 GalleryFolder1
...
func (o *GalleryFolder1) UnmarshalJSON(data []byte) (err error) {
	...
	varGalleryFolder1 := _GalleryFolder1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGalleryFolder1)

	if err != nil {
		return err
	}

	*o = GalleryFolder1(varGalleryFolder1)
