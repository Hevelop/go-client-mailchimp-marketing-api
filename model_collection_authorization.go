...
type _CollectionAuthorization CollectionAuthorization
...
// ContainsCurrentTotalInstances returns a boolean if a field has been set.
func (o *CollectionAuthorization) ContainsCurrentTotalInstances() bool {
	if o != nil && !IsNil(o.CurrentTotalInstances) {
		return true
	}
...
func (o *CollectionAuthorization) UnmarshalJSON(data []byte) (err error) {
	...
	varCollectionAuthorization := _CollectionAuthorization{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCollectionAuthorization)

	if err != nil {
		return err
	}

	*o = CollectionAuthorization(varCollectionAuthorization)
