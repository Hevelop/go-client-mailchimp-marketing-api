...
// HaveContentLabel returns a boolean if a field has been set.
func (o *VariateContentsInner) HaveContentLabel() bool {
	if o != nil && !IsNil(o.ContentLabel) {
		return true
	}
...
func (o *VariateContentsInner) HavePlainText() bool {
	if o != nil && !IsNil(o.PlainText) {
		return true
	}
...
func (o *VariateContentsInner) HaveHtml() bool {
	if o != nil && !IsNil(o.Html) {
		return true
	}
