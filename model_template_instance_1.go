...
type _TemplateInstance1 TemplateInstance1
...
func (o *TemplateInstance1) ContainsFolderId() bool {
	if o != nil && !IsNil(o.FolderId) {
		return true
	}
...
func (o *TemplateInstance1) UnmarshalJSON(data []byte) (err error) {
	...
	varTemplateInstance1 := _TemplateInstance1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTemplateInstance1)

	if err != nil {
		return err
	}

	*o = TemplateInstance1(varTemplateInstance1)
