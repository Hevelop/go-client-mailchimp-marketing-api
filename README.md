...
Similar rules for overriding default operation server index and variables applies by using `mailchimpmarketingapi.ContextOperationServerIndices` and `mailchimpmarketingapi.ContextOperationServerVariables` context maps.
...
## Documentation For Models
 ...
 - [ECommerceCustomer6](docs/ECommerceCustomer6.md)
