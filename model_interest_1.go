...
func (o *Interest1) ContainsDisplayOrder() bool {
	if o != nil && !IsNil(o.DisplayOrder) {
		return true
	}
...
func (o *Interest1) UnmarshalJSON(data []byte) (err error) {
	...
	varInterest1 := _Interest1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInterest1)

	if err != nil {
		return err
	}

	*o = Interest1(varInterest1)
