...
func (o *ECommerceCartLineItem2) HaveProductId() bool {
	if o != nil && !IsNil(o.ProductId) {
		return true
	}
...
func (o *ECommerceCartLineItem2) HaveProductVariantId() bool {
	if o != nil && !IsNil(o.ProductVariantId) {
		return true
	}
...
func (o *ECommerceCartLineItem2) HaveQuantity() bool {
	if o != nil && !IsNil(o.Quantity) {
		return true
	}
...
func (o *ECommerceCartLineItem2) HavePrice() bool {
	if o != nil && !IsNil(o.Price) {
		return true
	}
