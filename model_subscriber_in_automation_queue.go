...
type _SubscriberInAutomationQueue SubscriberInAutomationQueue
...
func (o *SubscriberInAutomationQueue) HaveId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *SubscriberInAutomationQueue) HaveWorkflowId() bool {
	if o != nil && !IsNil(o.WorkflowId) {
		return true
	}
...
func (o *SubscriberInAutomationQueue) HaveEmailId() bool {
	if o != nil && !IsNil(o.EmailId) {
		return true
	}
...
func (o *SubscriberInAutomationQueue) HaveListId() bool {
	if o != nil && !IsNil(o.ListId) {
		return true
	}
...
func (o *SubscriberInAutomationQueue) HaveNextSend() bool {
	if o != nil && !IsNil(o.NextSend) {
		return true
	}
...
func (o *SubscriberInAutomationQueue) HaveLinks() bool {
	if o != nil && !IsNil(o.Links) {
		return true
	}
...
func (o *SubscriberInAutomationQueue) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriberInAutomationQueue := _SubscriberInAutomationQueue{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriberInAutomationQueue)

	if err != nil {
		return err
	}

	*o = SubscriberInAutomationQueue(varSubscriberInAutomationQueue)
