...
type _ECommerceOrderLineItem1 ECommerceOrderLineItem1
...
func (o *ECommerceOrderLineItem1) ContainsDiscount() bool {
	if o != nil && !IsNil(o.Discount) {
		return true
	}
...
func (o *ECommerceOrderLineItem1) UnmarshalJSON(data []byte) (err error) {
	...
	varECommerceOrderLineItem1 := _ECommerceOrderLineItem1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varECommerceOrderLineItem1)

	if err != nil {
		return err
	}

	*o = ECommerceOrderLineItem1(varECommerceOrderLineItem1)
