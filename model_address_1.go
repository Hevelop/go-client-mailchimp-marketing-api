...
func (o *Address1) HaveAddress1() bool {
	if o != nil && !IsNil(o.Address1) {
		return true
	}
...
func (o *Address1) HaveAddress2() bool {
	if o != nil && !IsNil(o.Address2) {
		return true
	}
...
func (o *Address1) HaveProvince() bool {
	if o != nil && !IsNil(o.Province) {
		return true
	}
...
func (o *Address1) HaveProvinceCode() bool {
	if o != nil && !IsNil(o.ProvinceCode) {
		return true
	}
...
func (o *Address1) HavePostalCode() bool {
	if o != nil && !IsNil(o.PostalCode) {
		return true
	}
...
func (o *Address1) HaveCountry() bool {
	if o != nil && !IsNil(o.Country) {
		return true
	}
...
func (o *Address1) HaveCountryCode() bool {
	if o != nil && !IsNil(o.CountryCode) {
		return true
	}
...
func (o *Address1) HaveLongitude() bool {
	if o != nil && !IsNil(o.Longitude) {
		return true
	}
...
func (o *Address1) HaveLatitude() bool {
	if o != nil && !IsNil(o.Latitude) {
		return true
	}
