...
func (o *RSSOptions1) ContainsSchedule() bool {
	if o != nil && !IsNil(o.Schedule) {
		return true
	}
...
func (o *RSSOptions1) ContainsConstrainRssImg() bool {
	if o != nil && !IsNil(o.ConstrainRssImg) {
		return true
	}
...
func (o *RSSOptions1) UnmarshalJSON(data []byte) (err error) {
	...
	varRSSOptions1 := _RSSOptions1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRSSOptions1)

	if err != nil {
		return err
	}

	*o = RSSOptions1(varRSSOptions1)
