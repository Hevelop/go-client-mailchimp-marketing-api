...
type _ECommerceCart1 ECommerceCart1
...
func (o *ECommerceCart1) ContainsCampaignId() bool {
	if o != nil && !IsNil(o.CampaignId) {
		return true
	}
...
func (o *ECommerceCart1) ContainsCheckoutUrl() bool {
	if o != nil && !IsNil(o.CheckoutUrl) {
		return true
	}
...
func (o *ECommerceCart1) ContainsTaxTotal() bool {
	if o != nil && !IsNil(o.TaxTotal) {
		return true
	}
...
func (o *ECommerceCart1) UnmarshalJSON(data []byte) (err error) {
	...
	varECommerceCart1 := _ECommerceCart1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varECommerceCart1)

	if err != nil {
		return err
	}

	*o = ECommerceCart1(varECommerceCart1)
