...
type _CampaignFolder1 CampaignFolder1
...
func (o *CampaignFolder1) UnmarshalJSON(data []byte) (err error) {
	...
	varCampaignFolder1 := _CampaignFolder1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCampaignFolder1)

	if err != nil {
		return err
	}

	*o = CampaignFolder1(varCampaignFolder1)
