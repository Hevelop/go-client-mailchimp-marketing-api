...
// HaveChimpChatter returns a boolean if a field has been set.
func (o *GetActivityFeedChimpChatter200Response) HaveChimpChatter() bool {
	if o != nil && !IsNil(o.ChimpChatter) {
		return true
	}
...
func (o *GetActivityFeedChimpChatter200Response) HaveTotalItems() bool {
	if o != nil && !IsNil(o.TotalItems) {
		return true
	}
...
func (o *GetActivityFeedChimpChatter200Response) HaveLinks() bool {
	if o != nil && !IsNil(o.Links) {
		return true
	}
