...
func (o *EcommerceProductVariants) HaveStoreId() bool {
	if o != nil && !IsNil(o.StoreId) {
		return true
	}
...
func (o *EcommerceProductVariants) HaveProductId() bool {
	if o != nil && !IsNil(o.ProductId) {
		return true
	}
...
func (o *EcommerceProductVariants) HaveVariants() bool {
	if o != nil && !IsNil(o.Variants) {
		return true
	}
...
func (o *EcommerceProductVariants) HaveTotalItems() bool {
	if o != nil && !IsNil(o.TotalItems) {
		return true
	}
...
func (o *EcommerceProductVariants) HaveLinks() bool {
	if o != nil && !IsNil(o.Links) {
		return true
	}
