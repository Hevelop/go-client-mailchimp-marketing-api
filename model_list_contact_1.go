...
type _ListContact1 ListContact1
...
func (o *ListContact1) ContainsAddress2() bool {
	if o != nil && !IsNil(o.Address2) {
		return true
	}
...
func (o *ListContact1) ContainsState() bool {
	if o != nil && !IsNil(o.State) {
		return true
	}
...
func (o *ListContact1) ContainsZip() bool {
	if o != nil && !IsNil(o.Zip) {
		return true
	}
...
func (o *ListContact1) ContainsPhone() bool {
	if o != nil && !IsNil(o.Phone) {
		return true
	}
...
func (o *ListContact1) UnmarshalJSON(data []byte) (err error) {
	...
	varListContact1 := _ListContact1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListContact1)

	if err != nil {
		return err
	}

	*o = ListContact1(varListContact1)
