...
type _InterestCategory1 InterestCategory1
...
func (o *InterestCategory1) ContainsDisplayOrder() bool {
	if o != nil && !IsNil(o.DisplayOrder) {
		return true
	}
...
func (o *InterestCategory1) UnmarshalJSON(data []byte) (err error) {
	...
	varInterestCategory1 := _InterestCategory1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInterestCategory1)

	if err != nil {
		return err
	}

	*o = InterestCategory1(varInterestCategory1)
