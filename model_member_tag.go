...
func (o *MemberTag) UnmarshalJSON(data []byte) (err error) {
	...
	varMemberTag := _MemberTag{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMemberTag)

	if err != nil {
		return err
	}

	*o = MemberTag(varMemberTag)
