...
func (o *AddListMembers3) ContainsEmailAddress() bool {
	if o != nil && !IsNil(o.EmailAddress) {
		return true
	}
...
func (o *AddListMembers3) ContainsEmailType() bool {
	if o != nil && !IsNil(o.EmailType) {
		return true
	}
...
func (o *AddListMembers3) ContainsStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *AddListMembers3) ContainsMergeFields() bool {
	if o != nil && !IsNil(o.MergeFields) {
		return true
	}
...
func (o *AddListMembers3) ContainsInterests() bool {
	if o != nil && !IsNil(o.Interests) {
		return true
	}
...
func (o *AddListMembers3) ContainsLanguage() bool {
	if o != nil && !IsNil(o.Language) {
		return true
	}
...
func (o *AddListMembers3) ContainsVip() bool {
	if o != nil && !IsNil(o.Vip) {
		return true
	}
...
func (o *AddListMembers3) ContainsLocation() bool {
	if o != nil && !IsNil(o.Location) {
		return true
	}
...
func (o *AddListMembers3) ContainsMarketingPermissions() bool {
	if o != nil && !IsNil(o.MarketingPermissions) {
		return true
	}
...
func (o *AddListMembers3) ContainsIpSignup() bool {
	if o != nil && !IsNil(o.IpSignup) {
		return true
	}
...
func (o *AddListMembers3) ContainsTimestampSignup() bool {
	if o != nil && !IsNil(o.TimestampSignup) {
		return true
	}
...
func (o *AddListMembers3) ContainsIpOpt() bool {
	if o != nil && !IsNil(o.IpOpt) {
		return true
	}
...
func (o *AddListMembers3) ContainsTimestampOpt() bool {
	if o != nil && !IsNil(o.TimestampOpt) {
		return true
	}
