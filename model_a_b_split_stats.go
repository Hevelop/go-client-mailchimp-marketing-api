...
// HaveA returns a boolean if a field has been set.
func (o *ABSplitStats) HaveA() bool {
	if o != nil && !IsNil(o.A) {
		return true
	}
...
// HaveB returns a boolean if a field has been set.
func (o *ABSplitStats) HaveB() bool {
	if o != nil && !IsNil(o.B) {
		return true
	}
