...
type _CampaignDefaults1 CampaignDefaults1
...
func (o *CampaignDefaults1) UnmarshalJSON(data []byte) (err error) {
	...
	varCampaignDefaults1 := _CampaignDefaults1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCampaignDefaults1)

	if err != nil {
		return err
	}

	*o = CampaignDefaults1(varCampaignDefaults1)
