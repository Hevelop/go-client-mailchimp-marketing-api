...
type _SubscriberLists SubscriberLists
...
func (o *SubscriberLists) ContainsTotalItems() bool {
	if o != nil && !IsNil(o.TotalItems) {
		return true
	}
...
// ContainsConstraints returns a boolean if a field has been set.
func (o *SubscriberLists) ContainsConstraints() bool {
	if o != nil && !IsNil(o.Constraints) {
		return true
	}
...
func (o *SubscriberLists) ContainsLinks() bool {
	if o != nil && !IsNil(o.Links) {
		return true
	}
...
func (o *SubscriberLists) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriberLists := _SubscriberLists{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriberLists)

	if err != nil {
		return err
	}

	*o = SubscriberLists(varSubscriberLists)
