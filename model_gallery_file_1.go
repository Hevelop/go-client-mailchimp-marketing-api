...
type _GalleryFile1 GalleryFile1
...
func (o *GalleryFile1) HaveFolderId() bool {
	if o != nil && !IsNil(o.FolderId) {
		return true
	}
...
func (o *GalleryFile1) UnmarshalJSON(data []byte) (err error) {
	...
	varGalleryFile1 := _GalleryFile1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGalleryFile1)

	if err != nil {
		return err
	}

	*o = GalleryFile1(varGalleryFile1)
