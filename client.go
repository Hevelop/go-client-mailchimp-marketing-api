...
type APIClient struct {
	...
	AccountExportAPI AccountExportAPI

	AccountExportsAPI AccountExportsAPI

	ActivityFeedAPI ActivityFeedAPI

	AuthorizedAppsAPI AuthorizedAppsAPI

	AutomationsAPI AutomationsAPI

	BatchWebhooksAPI BatchWebhooksAPI

	BatchesAPI BatchesAPI

	CampaignFoldersAPI CampaignFoldersAPI

	CampaignsAPI CampaignsAPI

	ConnectedSitesAPI ConnectedSitesAPI

	ConversationsAPI ConversationsAPI

	CustomerJourneysAPI CustomerJourneysAPI
	...
	SearchCampaignsAPI SearchCampaignsAPI

	SearchMembersAPI SearchMembersAPI

	SurveysAPI SurveysAPI

	TemplateFoldersAPI TemplateFoldersAPI

	TemplatesAPI TemplatesAPI

	VerifiedDomainsAPI VerifiedDomainsAPI
}
