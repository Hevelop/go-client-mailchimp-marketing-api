...
type _ProblemDetailDocument ProblemDetailDocument
...
func (o *ProblemDetailDocument) UnmarshalJSON(data []byte) (err error) {
	...
	varProblemDetailDocument := _ProblemDetailDocument{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varProblemDetailDocument)

	if err != nil {
		return err
	}

	*o = ProblemDetailDocument(varProblemDetailDocument)
